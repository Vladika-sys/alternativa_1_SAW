...
<nav class="navbar navbar-expand-md fixed-top navbar-shrink py-3 navbar-light" id="mainNav">
    <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span>Brand</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse" id="navcol-1">
            ...
            </ul><a class="btn btn-primary shadow" role="button" href="./login_form.php">Log in</a>
        </div>
    </div>
</nav>
<body>
...
<div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
    <div class="row w-50">
        <div class="col ">
            ...
            <form method="post" action="./admin/signup.php" class="needs-validation" data-bs-theme="light" novalidate>
                <?php
                session_start();
                ...
                ?>
                <div class="mb-3">
                    <input class="shadow form-control" id="login" type="text" value="<?php if(isset($_SESSION['login'])){echo $_SESSION['login']; unset($_SESSION['login']);} ?>" name="login" placeholder="login">
                ...
                <div class="mb-5">
                    <input value="Sign up" class="btn btn-primary shadow" name="submit" type="submit"/>
                </div>
            </form>

            <p class="text-muted"><a href="./login_form.php">Am deja un cont</a></p>
        </div>
    </div>
</body>
<script>
